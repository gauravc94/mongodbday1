...
//creating a collection named products and inserting the documents
...
db.products.aggregate([
    {
      $group: {
        _id: "$product_price", // Group by the product_price field
        count: { $sum: 1 } 
      }
    },
    {
    ...
    // Delete all documents with the same product_price
    db.products.deleteMany({ "product_price": group._id });
  });
